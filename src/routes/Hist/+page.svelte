<div class="grid grid-cols-2 gap-4 w-[90%] m-20 ">
    <div>
        <img
            src="https://www.nasa.gov/wp-content/uploads/2023/03/jsc2014e025526.jpg?resize=675,900"
            alt="Monument to Iurii Gagarin"
            width="500"
        />
        <img
            src="https://upload.wikimedia.org/wikipedia/commons/4/45/RIAN_archive_409173_World%27s_first_nuclear_power_plant_in_Obninsk.jpg"
            alt="Obninsk Nuclear Power Plant"
            width="500"
        />
